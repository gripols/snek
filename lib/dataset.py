...
def train_val_split(dataset_dir, split_mode, val_rate, val_filelist):
    if split_mode == 'random':
        ...
        train_filelist = make_pair(
            os.path.join(dataset_dir, 'training/mixes'),
            os.path.join(dataset_dir, 'training/instrs')
        )

        val_filelist = make_pair(
            os.path.join(dataset_dir, 'validation/mixes'),
            os.path.join(dataset_dir, 'validation/instrs')
        )
